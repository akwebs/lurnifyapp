    ...
    if(response.statusCode>200){
      ...
      database.transaction((txn) async {
        ...
        List<Map<String,dynamic>> list3 =await txn.rawQuery(
            "select sum(totalSeconds)/3600 as totalStudyHour from study where date='$yesterdayDate'");
        for(var a in list3){
      ...
      for(var a in leaderList){
        ...
        await FirebaseFirestore.instance.collection('lastOnline').where('register',isEqualTo: a['usedBy']['sno'].toString()).orderBy('lastLoginTime',descending: true).limit(1).get().then((QuerySnapshot snapshot) {
          snapshot.docs.forEach((element) {
                                                ...
                                                child: InkWell(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                            _currentFollowerField==1?'Study Hours'
                                                            :_currentFollowerField==2?'Dimes':'Test Percent'),
                                                        Icon(
                                                          Icons
                                                                      ...
                                                                      Expanded(
                                                                        child: Column(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                                _currentFollowerField==1?'${followersList[i].totalStudyHour} hours'
                                                                                    :_currentFollowerField==2?'${followersList[i].totalDimes} Dimes'
                                                ...
                                                child: InkWell(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                            _currentLeaderField==1?'Study Hours'
                                                                :_currentLeaderField==2?'Dimes':'Test Percent'),
                                                        Icon(
                                                          Icons
                                                              .swap_vertical_circle_sharp,
                                                          color: Colors.green,
                                                                      ...
                                                                      Expanded(
                                                                        child: Column(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                                _currentLeaderField==1?'${leadersList[i].totalStudyHour} hours'
                                                                                    :_currentLeaderField==2?'${leadersList[i].totalDimes} Dimes'
