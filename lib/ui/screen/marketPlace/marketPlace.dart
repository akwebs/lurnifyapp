        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            return Stack(children: [
              Positioned.fill(
                top:
                    -Responsive.getPercent(100, ResponsiveSize.HEIGHT, context),
                ...
                child: Container(
                  decoration: BoxDecoration(
                      ...
                      gradient: AppSlider.sliderGradient[0]),
                ),
              ),
              Container(
                height:
                          ...
                          child: Container(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                    ...
                                    fontSize: Responsive.getPercent(
                                        20, ResponsiveSize.WIDTH, context)),
                              )),
                        ),
                      ),
                      Padding(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              height: Responsive.getPercent(
                                  10, ResponsiveSize.HEIGHT, context),
                              child: ListView(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: SizedBox(
                                      ...
                                      width: 60,
                                      child:
                                          Image.asset('assets/images/dime.png'),
                                    ),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
