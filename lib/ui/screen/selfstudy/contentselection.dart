...
class _ContentSelectionState extends State<ContentSelection> {
  ...
  Future _getSubjects() async {
    ...
    List<Subject> list = (jsonDecode(response.body) as List)
        .map((e) => Subject.fromJson(e))
        .toList();
    // bhai ye wale list me data aa gya hai sara
  ...
  Widget _unitGrids() {
    return SliverGrid(
      ...
      delegate: SliverChildBuilderDelegate(
        ...
        childCount: _section == null ? 1 : _section.length,
      ),
    );
  }
