...
class TopicProgress extends StatefulWidget {
  ...
  @override
  _TopicProgressState createState() => _TopicProgressState(chapterSno, cname, topics);
}
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => StartTimer(topics[i]['courseSno'], topics[i]['subjectSno'], topics[i]['unitSno'], topics[i]['chapterSno'], topics[i]['topicSno'],
                                          topics[i]['subtopic'], topics[i]['duration'])));
                            },
                          ),
                        ),
                      ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: Container(
                      child: _topicInfo(
                        i,
                        'Revision',
                        topics[i]['revision'] == null ? "0" : topics[i]['revision'].toString(),
                      ),
                      decoration: BoxDecoration(
                        border: Border(right: BorderSide(width: 0.5, color: Colors.grey[500])),
                      ),
                  ...
                  Expanded(
                    flex: 1,
                    child: Container(child: _topicInfo(i, 'Last Studied', topics[i]['lastStudied'] == null ? "Not studied yet" : topics[i]['lastStudied'].toString() + ' days ago')),
                  ),
                ],
              ),
            ),
