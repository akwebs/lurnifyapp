...
import 'package:lurnify/ui/screen/myCourseContain/preview/class_note_preview.dart';
            ...
            return GestureDetector(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => ClassNoteImagePreview(_classNotes, i),
                ));
              },
              child: Padding(
                padding: EdgeInsets.all(10),
