...
import 'package:lurnify/ui/screen/myCourseContain/PreciseTheoryImagePreview.dart';
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context,i){
            return GestureDetector(
              onTap: (){
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => PreciseTheoryImagePreview(_preciseTheory,i),));
              },
              child: Padding(
                padding: EdgeInsets.all(10),
                child: Container(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.map),
                      SizedBox(width: 10,),
                      Expanded(child: Text(_preciseTheory[i]['preciseName'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w800),)),
