...
class _MyReportHomeState extends State<MyReportHome> {
  ...
  _getMyReport() async {
    try {
      ...
      TopicTestResultRepo repo = new TopicTestResultRepo();
      ...
      for (var a in _subjectData) {
        totalCompletedTopicMinutes =
            totalCompletedTopicMinutes + (a['totalCompletedTopicMinutes'] ?? 0);
        totalTopicDurationInMinute =
            totalTopicDurationInMinute + (a['totalTopicDurationInMinute'] ?? 0);
      ...
      _syllabusCompleted =
          (totalCompletedTopicMinutes / totalTopicDurationInMinute);
                        ...
                        InkWell(
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) =>
                                  MyReportOverAll(_subjectData, -1),
                            ));
                          },
                          child: AspectRatio(
                            aspectRatio: 3 / 1.4,
                        ...
                        Container(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, i) {
                              double totalCompletedTopicMinutes =
                                  _subjectData[i]['totalCompletedTopicMinutes']
                                          .toDouble() ??
                                      0;
                              double totalTopicDurationInMinute =
                                  _subjectData[i]['totalTopicDurationInMinute']
                                          .toDouble() ??
                                      0;
                              double syllabusCompleted =
                                  (totalCompletedTopicMinutes /
                                      totalTopicDurationInMinute);
                              if (syllabusCompleted == null ||
                                  syllabusCompleted.isNaN) {
                                syllabusCompleted = 0;
                              } else if (totalCompletedTopicMinutes > 0 &&
                                  totalTopicDurationInMinute == 0) {
                                syllabusCompleted = 0;
                              ...
                              double subProgress =
                                  syllabusCompleted / _preparationTimePassed;
                                  ...
                                  InkWell(
                                    onTap: () {
                                      Navigator.of(context)
                                        ...
                                        builder: (context) =>
                                            MyReportOverAll(_subjectData, i),
                                      ));
                                    },
                                    child: AspectRatio(
                                      aspectRatio: 3 / 1.4,
