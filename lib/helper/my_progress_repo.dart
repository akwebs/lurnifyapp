  ...
  getMyProgress(String status, String revision, String register) async {
    ...
    await database.transaction((txn) async {
      ...
      for (var a in list) {
        ...
        String sql4 = "SELECT COUNT(DISTINCT topicSno) from study " + "where register=$register and revision='$revision' " + "and subjectSno=${a['subjectSno']} and topicCompletionStatus='$status'";
        ...
        String sql5 = "SELECT COUNT(DISTINCT topicSno) from study " + "where register=$register and revision='$revision' " + "and unitSno=${a['unitSno']} and topicCompletionStatus='$status'";
